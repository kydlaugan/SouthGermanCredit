...
Analyse <- div(class="container",
  p(class="text-center text-4xl underline  decoration-sky-500 decoration-double titre mt-4","Analyse descriptive des données") ,
  ...
  #summary
  div(class="mx-12",
      h1(class="text-center text-4xl underline  decoration-sky-500 decoration-double titre"," Vue sommaire des données ") ,br(),
  ...
  #boite à moustache
  div(class="mx-12",
      h1(class="text-center text-4xl underline  decoration-sky-500 decoration-double titre","Boite à moustache de chaque attribut") , br(),
  ...
  #nuage de point
  div(class="mx-12",
      h1(class="text-center text-4xl underline  decoration-sky-500 decoration-double titre","Nuage de Points"),
